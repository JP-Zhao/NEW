...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("OUTPUT_STREAM_TDATA", 32, hls_in, 7, "axis", "in_data", 1),
	Port_Property("OUTPUT_STREAM_TKEEP", 4, hls_in, 8, "axis", "in_data", 1),
	Port_Property("OUTPUT_STREAM_TSTRB", 4, hls_in, 9, "axis", "in_data", 1),
	Port_Property("OUTPUT_STREAM_TUSER", 1, hls_in, 10, "axis", "in_data", 1),
	Port_Property("OUTPUT_STREAM_TLAST", 1, hls_in, 11, "axis", "in_data", 1),
	Port_Property("OUTPUT_STREAM_TID", 1, hls_in, 12, "axis", "in_data", 1),
	Port_Property("OUTPUT_STREAM_TDEST", 1, hls_in, 13, "axis", "in_data", 1),
	Port_Property("INPUT_STREAM_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("INPUT_STREAM_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
};
const char* HLS_Design_Meta::dut_name = "TOP_fuct";
