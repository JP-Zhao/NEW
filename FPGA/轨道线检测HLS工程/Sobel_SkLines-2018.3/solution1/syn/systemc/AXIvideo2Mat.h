...
struct AXIvideo2Mat : public sc_module {
    ...
    sc_signal< sc_lv<32> > t_V_6_reg_222;
    ...
    sc_signal< sc_lv<1> > exitcond9_i_fu_323_p2;
    ...
    sc_signal< sc_lv<8> > tmp_23_reg_440;
    sc_signal< sc_lv<8> > tmp_24_reg_445;
    ...
    void thread_exitcond9_i_fu_323_p2();
