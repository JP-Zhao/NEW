...
#ifndef _TOP_fuct_entry3_HH_
#define _TOP_fuct_entry3_HH_
...
struct TOP_fuct_entry3 : public sc_module {
    ...
    // Module declarations
    TOP_fuct_entry3(sc_module_name name);
    SC_HAS_PROCESS(TOP_fuct_entry3);
