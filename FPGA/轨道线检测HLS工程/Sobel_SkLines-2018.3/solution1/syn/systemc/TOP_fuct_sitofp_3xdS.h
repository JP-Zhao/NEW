...
// ==============================================================
#ifndef __TOP_fuct_sitofp_3xdS__HH__
#define __TOP_fuct_sitofp_3xdS__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_sitofp_3xdS) {
    ...
    SC_CTOR(TOP_fuct_sitofp_3xdS):  ACMP_sitofp_U ("ACMP_sitofp_U") {
