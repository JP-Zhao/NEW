...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_5_reg_107, "t_V_5_reg_107");
...
void Duplicate::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        t_V_5_reg_107 = j_V_fu_142_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond8_i_fu_126_p2.read()))) {
...
void Duplicate::thread_exitcond8_i_fu_126_p2() {
...
void Duplicate::thread_exitcond_i_fu_137_p2() {
    exitcond_i_fu_137_p2 = (!t_V_5_reg_107.read().is_01() || !cols_V_reg_153.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_5_reg_107.read() == cols_V_reg_153.read());
}
...
void Duplicate::thread_j_V_fu_142_p2() {
    j_V_fu_142_p2 = (!t_V_5_reg_107.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(t_V_5_reg_107.read()) + sc_biguint<32>(ap_const_lv32_1));
}
