...
// ==============================================================
#ifndef __TOP_fuct_mac_mulaibs__HH__
#define __TOP_fuct_mac_mulaibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_mac_mulaibs) {
    ...
    SC_CTOR(TOP_fuct_mac_mulaibs):  simcore_mac_2_U ("simcore_mac_2_U") {
