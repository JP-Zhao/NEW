...
默认参数的测试
--ckpt
checkpoints/bak1/best_deeplabv3plus_mobilenet_voc_os16.pth
--test_only
--save_val_results
--batch_size
8
...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='../data/my_cityspaces_output2.0',
    ...
    parser.add_argument("--total_itrs", type=int, default=100,
                        help="epoch number (default: 30k)")     #训练次数30e3
