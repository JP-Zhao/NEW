...
// ==============================================================
#ifndef __TOP_fuct_faddfsubudo__HH__
#define __TOP_fuct_faddfsubudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_faddfsubudo) {
    ...
    SC_CTOR(TOP_fuct_faddfsubudo):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
