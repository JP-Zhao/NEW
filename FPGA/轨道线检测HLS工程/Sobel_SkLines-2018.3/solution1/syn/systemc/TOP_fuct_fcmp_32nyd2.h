...
// ==============================================================
#ifndef __TOP_fuct_fcmp_32nyd2__HH__
#define __TOP_fuct_fcmp_32nyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_fcmp_32nyd2) {
    ...
    SC_CTOR(TOP_fuct_fcmp_32nyd2):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
