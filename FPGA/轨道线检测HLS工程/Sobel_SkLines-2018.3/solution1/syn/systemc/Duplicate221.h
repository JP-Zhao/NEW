...
#ifndef _Duplicate221_HH_
#define _Duplicate221_HH_
...
struct Duplicate221 : public sc_module {
    ...
    // Module declarations
    Duplicate221(sc_module_name name);
    SC_HAS_PROCESS(Duplicate221);
    ...
    sc_signal< sc_lv<1> > exitcond8_i_fu_126_p2;
    ...
    void thread_exitcond8_i_fu_126_p2();
