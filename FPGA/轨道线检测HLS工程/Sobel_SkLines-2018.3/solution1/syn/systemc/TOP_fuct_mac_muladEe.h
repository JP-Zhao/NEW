...
// ==============================================================
#ifndef __TOP_fuct_mac_muladEe__HH__
#define __TOP_fuct_mac_muladEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_mac_muladEe) {
    ...
    SC_CTOR(TOP_fuct_mac_muladEe):  simcore_mac_1_U ("simcore_mac_1_U") {
