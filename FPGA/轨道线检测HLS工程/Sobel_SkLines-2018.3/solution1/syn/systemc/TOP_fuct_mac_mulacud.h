...
// ==============================================================
#ifndef __TOP_fuct_mac_mulacud__HH__
#define __TOP_fuct_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_mac_mulacud) {
    ...
    SC_CTOR(TOP_fuct_mac_mulacud):  simcore_mac_0_U ("simcore_mac_0_U") {
