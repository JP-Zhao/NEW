...
// ==============================================================
#ifndef __TOP_fuct_fmul_32nvdy__HH__
#define __TOP_fuct_fmul_32nvdy__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(TOP_fuct_fmul_32nvdy) {
    ...
    SC_CTOR(TOP_fuct_fmul_32nvdy):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
